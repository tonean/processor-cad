...
export const BottomToolbar = ({
  ...
  return <div className="flex items-center bg-white dark:bg-gray-800 rounded-lg shadow-md p-1 text-gray-800 dark:text-gray-200 transition-colors duration-200">
