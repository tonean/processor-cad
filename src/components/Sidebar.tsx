...
export const Sidebar = ({
  ...
  return <aside className="w-64 border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 overflow-y-auto text-gray-800 dark:text-gray-200 transition-colors duration-200">
      <div className="p-3">
        ...
        <div className="mb-4">
          <button className="w-full text-left px-3 py-2 bg-blue-50 dark:bg-blue-900 text-blue-700 dark:text-blue-200 rounded-md transition-colors duration-200">
            Page 1
          </button>
        </div>
        <div>
          <h2 className="font-medium mb-2">Chats</h2>
